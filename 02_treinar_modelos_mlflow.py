...
from sklearn.impute import KNNImputer # muito importantepara lidar com nulos, especialmente para o modelo de Random Forest
from sklearn.model_selection import train_test_split
from sklearn.compose import ColumnTransformer
from sklearn.preprocessing import StandardScaler
from sklearn.pipeline import Pipeline
# Adicionando os modelos de classificação
...
def separar_dados(df):
    ...
    # Criando um sub-pipeline para as colunas numéricas: Primeiro Imputa, depois Escala!
    pipeline_numerico = Pipeline(
        steps=[
            # KNNImputer (Mais robusto, analisa vizinhos próximos)
    ...
    # Aplicando o pipeline numérico de forma explícita no ColumnTransformer
...
def main():
    ...
    modelos = {
        ...
        "XGBoost": XGBClassifier(
            ...
            max_depth=5,
            learning_rate=0.05,
            eval_metric="logloss"  # Evita avisos de depreciação no terminal
        ),
        ...
        "SVM": SVC(
            kernel="rbf",           # Kernel não-linear para capturar a complexidade da água
            probability=True,       # Necessário para calcular probabilidades e curvas ROC mais tarde
            class_weight="balanced",# Trata o desbalanceamento nativamente
            random_state=42
        ),
        "LightGBM": LGBMClassifier(
            ...
            class_weight="balanced", # Trata o desbalanceamento nativamente
            random_state=42,
            verbosity=-1             # Evita logs excessivos poluindo o terminal
        )
    }
